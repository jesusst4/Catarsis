...
<?php
	...
	if (is_array($imgs)){
		foreach($imgs as $img){
			...
			echo '<td align="center" valign="middle"><a href="javascript:parent.insertUrl(\''.BASE_RUTA_HTTP.$img.'\')" title="'.$img.'"><img  style="width:150px;height:150px;" src="lib/phpthumb/phpThumb.php?src=' . BASE_RUTA.$img . '"&w=150&h=150" border="0" onmouseover="resaltar(this)" onmouseout="no_resaltar(this)"></a><br><div align="center"><input name="nom[]" type="checkbox" value="'.$img.'"></div></td>';
